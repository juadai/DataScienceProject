...
```{r}
plot(uf_30, xlab="plot and quadrat number (i*j) where i=1 to 12 (excluding 3) and j=1,..,16", ylab="change in number of species from Y0 to Y3 (unfenced)", col=c(rep(4,16),rep(6,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(4,16),rep(2,16),rep(4,16),rep(6,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
...
treatments_30
boxplot(treatments_30$`change in number of species`~treatments_30$treatment, xlab="treatment", ylab="change in number of species from Y0 to Y3 (unfenced)")

plot(uf_63, xlab="plot and quadrat number (i*j) where i=1 to 12 (excluding 3) and j=1,..,16", ylab="change in number of species from Y3 to Y6 (unfenced)", col=c(rep(4,16),rep(6,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(4,16),rep(2,16),rep(4,16),rep(6,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
...
treatments_63
boxplot(treatments_63$`change in number of species`~treatments_63$treatment, xlab="treatment", ylab="change in number of species from Y3 to Y6 (unfenced)")

plot(uf_60, xlab="plot and quadrat number (i*j) where i=1,...,12 and j=1,..,16", ylab="change in number of species from Y0 to Y6 (unfenced)", col=c(rep(4,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(4,16),rep(2,16),rep(4,16),rep(6,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
...
treatments_60
boxplot(treatments_60$`change in number of species`~treatments_60$treatment, xlab="treatment", ylab="change in number of species from Y0 to Y6 (unfenced)")
```

Fenced quadrats with different treatments
```{r}
plot(f_30, xlab="16 quadrats for plot 7,9,10,12 respectively", ylab="change in number of species from Y0 to Y3 (fenced)", col=c(rep(2,16),rep(2,16),rep(4,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("bottom", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
treatments_30_f
boxplot(treatments_30_f$`change in number of species`~treatments_30_f$treatment, xlab="treatment", ylab="change in number of species from Y0 to Y3 (fenced)")

plot(f_63, xlab="16 quadrats for plot 7,9,10,12 respectively", ylab="change in number of species from Y3 to Y6 (fenced)", col=c(rep(2,16),rep(2,16),rep(4,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
...
treatments_63_f
boxplot(treatments_63_f$`change in number of species`~treatments_63_f$treatment, xlab="treatment", ylab="change in number of species from Y3 to Y6 (fenced)")

plot(f_60, xlab="16 quadrats for plot 7,9,10,12 respectively", ylab="change in number of species from Y0 to Y6 (fenced)", col=c(rep(2,16),rep(2,16),rep(4,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("bottom", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
treatments_60_f
boxplot(treatments_60_f$`change in number of species`~treatments_60_f$treatment, xlab="treatment", ylab="change in number of species from Y0 to Y6 (fenced)")
```
...
Unfenced quadrats with different treatments
```{r}
plot(uf_score_30, xlab="plot and quadrat number (i*j) where i=1 to 12 (excluding 3) and j=1,..,16", ylab="change in scores from Y0 to Y3 (unfenced)", col=c(rep(4,16),rep(6,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(4,16),rep(2,16),rep(4,16),rep(6,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("top", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
treatment_score_30
boxplot(treatment_score_30$`change in score`~treatment_score_30$treatment, xlab="treatment", ylab="change in score from Y0 to Y3 (unfenced)")

plot(uf_score_63, xlab="plot and quadrat number (i*j) where i=1 to 12 (excluding 3) and j=1,..,16", ylab="change in scores from Y3 to Y6 (unfenced)", col=c(rep(4,16),rep(6,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(4,16),rep(2,16),rep(4,16),rep(6,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("bottom", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
treatment_score_63
boxplot(treatment_score_63$`change in score`~treatment_score_63$treatment, xlab="treatment", ylab="change in score from Y3 to Y6 (unfenced)")

plot(uf_score_60, xlab="plot and quadrat number (i*j) where i=1,...,12 and j=1,..,16", ylab="change in scores from Y0 to Y6 (unfenced)", col=c(rep(4,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(6,16),rep(2,16),rep(4,16),rep(2,16),rep(4,16),rep(6,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
...
treatment_score_60
boxplot(treatment_score_60$`change in score`~treatment_score_60$treatment, xlab="treatment", ylab="change in score from Y0 to Y6 (unfenced)")
```

Fenced quadrats with different treatments
```{r}
plot(f_score_30, xlab="quadrats 1-16 for plot 7,9,10,12 respectively", ylab="change in score from Y0 to Y3 (fenced)", col=c(rep(2,16),rep(2,16),rep(4,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("bottomright", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
boxplot(treatment_score_30_f$`change in score`~treatment_score_30_f$treatment, xlab="treatment", ylab="change in score from Y0 to Y3 (fenced)")

plot(f_score_63, xlab="quadrats 1-16 for plot 7,9,10,12 respectively", ylab="change in scores from Y3 to Y6 (fenced)", col=c(rep(2,16),rep(2,16),rep(4,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("bottomright", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
boxplot(treatment_score_63_f$`change in score`~treatment_score_63_f$treatment, xlab="treatment", ylab="change in score from Y3 to Y6 (fenced)")

plot(f_score_60, xlab="quadrats 1-16 for plot 7,9,10,12 respectively", ylab="change in scores from Y0 to Y6 (fenced)", col=c(rep(2,16),rep(2,16),rep(4,16),rep(4,16)), pch=18)
abline(h=0, lty=2)
legend("bottomleft", legend = paste(c("T1","T2","Control")), col = c(4,2,6), pch = 18)
...
boxplot(treatment_score_60_f$`change in score`~treatment_score_60_f$treatment, xlab="treatment", ylab="change in score from Y0 to Y6 (fenced)")
```
