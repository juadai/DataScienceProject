...
summary(model2)
hnp(model2, xlab = "Half-normal scores", ylab = "Deviance residuals", main = "Negative Binomial model", pch = 4)
...
rsq
```
Half-normal plots with simulated envelopes for the deviance residuals from Negative Binomial model
## Gamma model fitting
